...
<link rel="icon" type="image/x-icon"
	href="/views/images/asfsIconTitle.png">
<!-- Bootstrap core CSS -->
...
<link rel="stylesheet"
	href="/src/main/webapp//views/assets/css/find_school.css">
				...
				<div class="col-12">
					<nav class="main-nav">
						...
						<a href="/views/index.jsp" class="logo" style="margin-right: 30px">
							<img alt="" src="/views/images/logoASFS.png"
						...
						<ul class="nav">
							<li class="scroll-to-section"><a href="#top" class="active">Giới
									thiệu</a></li>
							<li class="scroll-to-section"><a href="#services">Tìm
									trường</a></li>
				...
				<div class="header"
					...
					<div class="row">
						...
						<div class="col-sm-6 search-info pe-3">
							...
							<select class="form-select select-major mt-3 ms-5"
								name="majorName" style="height: 40px; width: 500px;">
					...
					<div
						class="text-center d-flex justify-content-center align-items-center pb-3">
						<input type="submit" class="btn btn-search mb-2"
							style="background-color: white; color: #7a6ad8; width: 100px;"
							value="Tìm kiếm"> <input type="submit"
							class="btn btn-reset mb-2 ms-2" onclick="resetForm()"
							style="background-color: white; color: #7a6ad8; width: 100;"
							value="Reset">
					</div>
					</form>
				</div>
							...
							<tbody>
								<c:forEach var="school" items="${schools}">
									<tr>
										...
										<td>${school.phone}</td>
										<td style=""><a href="${school.webSite}">${school.webSite}</a></td>
										<td class="w-50"><c:forEach var="schoolmajor" items="${schoolmajors}">
												<c:if test="${schoolmajor.schoolId == school.schoolId}">
													${schoolmajor.major}<br>
												</c:if>
											</c:forEach></td>
										<td><c:forEach var="majorSchool"
												items="${school.majorSchools}">
				...
				<c:forEach var="n" items="${list_new}">
					<div
						...
						<div class="events_item">
							<div class="thumb">
								<a href="${n.link_news}" target="_blank"> <img
									src="${n.link_image}" alt="">
					...
					<div class="col-lg-4 col-md-6">
						<div class="team-member">
							<div class="main-content">
								...
								<ul class="social-icons">
									<li><a
										href="https://www.facebook.com/profile.php?id=100035874030082"><i
											class="fab fa-facebook"></i></a></li>
									<li><a href="#"><i class="fab fa-twitter"></i></a></li>
									<li><a href="#"><i class="fab fa-linkedin"></i></a></li>
								</ul>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="contact-us-content">
						<form id="contact-form" action="/index/comments/create"
							method="post">
							<div class="row">
								<div class="col-lg-12">
									<fieldset>
		...
		<div class="container p-4">
			<div class="row justify-content-center">
				...
				<div class="col-lg-4 text-center">
					<img src="/views/images/logoASFS.png" alt="Website Logo"
						class="img-fluid" style="width: 200px"> <br>
				...
				<div class="col-lg-2 text-center">
					...
					<div>
						<a href="#!" class="text-white"><i
							class="fab fa-facebook fa-2x"></i></a> <a href="#!"
							class="text-white"><i class="fab fa-instagram fa-2x"></i></a> <a
