		...
		<div class="container">
			<div class="row">
				<div class="header" style="background-color: #DCDCDC;">
					...
					<div
						class="col-12 d-flex justify-content-center align-items-center mb-4">
						<div class="selected mr-3">
							<select class="form-control select-major"
								style="width: 200px; height: auto;">
								<option value="">Ngành</option>
							</select>
						</div>
						<div class="selected mr-3">
							<select class="form-control select-mass"
								style="width: 200px; height: auto;">
						...
						<div class="search-info position-relative">
							<input type="text" class="form-control"
								placeholder="Trường, điểm, học phí...">
						</div>
					</div>
				</div>
				<div class="col-12">
