...
(2, 'Mỹ thuật ứng dụng'),
(3, 'Nhân văn'),
(4, 'Ngôn ngữ, văn học và văn hóa nước ngoài'),
(5, 'Khoa học xã hội và hành vi'),
(6, 'Pháp luật'),
(7, 'Khoa học sự sống'),
(8, 'Máy tính và công nghệ thông tin'),
...
(13, 'Sức khoẻ'),
(14, 'Dịch vụ xã hội'),
(15, 'Du lịch, khách sạn, thể thao và dịch vụ cá nhân'),
(16, 'Môi trường và bảo vệ môi trường'),
